...
INSERT INTO `lab_mysql`.`cars` (`car_VIN`, `manufacturer`, `model`, `year`, `color`)
...
INSERT INTO `lab_mysql`.`customers` (`customer_id`, `name`, `phone number`, `email`, `address`, `city`, `province`, `country`, `zip`)
...
INSERT INTO `lab_mysql`.`invoices` (`invoice_number`, `date`, `Cars_id`, `Customers_id`, `Salesperson_id`) 
